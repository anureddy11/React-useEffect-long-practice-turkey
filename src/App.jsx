...
function App() {
  ...
  useEffect(() => {
    // console.log("State of red color is : ", isRed)
    // console.log("State of red color is : ", isOrange)
    // console.log("State of red color is : ", isBrown)
    // console.log("State of red color is : ", isLightBrown)
    // console.log("State of red color is : ", isYellow)
